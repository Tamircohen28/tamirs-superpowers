...
### Changed
- **Platform target: Claude Code 2.1.245** (from 2.1.233). Docs-only bump — no shipped
  ...
  - **2.1.245 — a Linux glibc 2.44 startup crash fix.** Host binary issue, no plugin
    surface.
  - `validated_against` advances to 2.1.245 by the same changelog + npm-registry method
