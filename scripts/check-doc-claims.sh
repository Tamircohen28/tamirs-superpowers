...
The tree ships 27 skills today.'
  ...
  # Section 4: the record pins cursor at 3.21.13.
  st_case "stale validated version in prose"  1 '| Cursor IDE | IDE | supported - validated 3.16.17 |'
  st_case "correct validated version in prose" 0 '| Cursor IDE | IDE | supported - validated 3.21.13 |'
...
# the badge three lines above it correctly said 3.21.13, and every check passed the whole
