...
Create new files here — **never** under `plugin/`, `docs/engineering/`, or other tracked trees — when the artifact is:
...
| Wrong | Right |
|-------|-------|
| `plugin/skills/SKILL-ENHANCEMENT-PLAN.md` | `.dev-files/plans/skill-enhancement-plan.md` |
...
If you find session plans or reviews already under `plugin/` or `docs/`, **move** them into `.dev-files/` (matching subdir) instead of expanding tracked docs. Do not delete user content without confirming.

See also: `.claude/rules/file-structure-governance.md`, `CLAUDE.md` § File Operations.
