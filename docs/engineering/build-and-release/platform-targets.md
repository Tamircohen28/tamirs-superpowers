...
Row 3 README badges show **platform tool versions** validated in this release — not the plugin semver (Row 1).

## Versions

Verified **2026-08-08** — Cursor public changelog reviewed through feature **3.11** + date entry **2026-08-03** (CLI pin remains **3.14.7**); Claude Code from registry.npmjs.org + the official changelog (automated nightly review); other CLIs by running each on the maintainer machine (2026-08-03).
