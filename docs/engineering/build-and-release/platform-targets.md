...
Verified **2026-08-04** — Claude Code from registry.npmjs.org + the official changelog (automated nightly review); other CLIs by running each on the maintainer machine (2026-08-03).

| Platform | Min supported | Validated against | Latest known | Install guide |
|----------|---------------|-------------------|--------------|---------------|
| Claude Code | 2.0.0 | 2.1.221 | 2.1.221 | [claude-code.md](../../user/install/claude-code.md) |
