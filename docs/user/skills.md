...
The toolkit ships **28 skills** in 7 domains — 25 you can invoke directly, 3 internal
...
| `/usage-capture` | Opt-in local per-request metrics (model, latency, skills). Claude Code via OTEL; OpenCode via an optional plugin. |
