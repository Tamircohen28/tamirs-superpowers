...
<p align="center">
  <a href="docs/engineering/build-and-release/platform-targets.json"><img src="https://img.shields.io/badge/Claude%20Code-2.1.268-blueviolet" alt="Claude Code" /></a>
...
|---|---|---|---|---|
| Claude Code | `claude_code` | CLI | ✅ supported — validated 2.1.268 | [guide](docs/user/install/claude-code.md) |
