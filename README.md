...
<p align="center">
  ...
  <a href="plugin-version.json"><img src="https://img.shields.io/badge/version-4.3.1-blue" alt="Version" /></a>
</p>
...
| Surface | Registry id | Kind | Status | Install |
|---|---|---|---|---|
| Cursor IDE | `cursor` | IDE | ✅ supported — validated 3.21.13 | [guide](docs/user/install/cursor.md) |
