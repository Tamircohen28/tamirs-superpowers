...
<p align="center">
  ...
  <a href="plugin-version.json"><img src="https://img.shields.io/badge/version-3.8.3-blue" alt="Version" /></a>
</p>

<p align="center">
  <a href="docs/engineering/build-and-release/platform-targets.json"><img src="https://img.shields.io/badge/Claude%20Code-2.1.278-blueviolet" alt="Claude Code" /></a>
...
A portable agent toolkit: **29 skills**, 10 role-based agents, worktree hooks, and MCP
...
|---|---|---|---|---|
| Claude Code | `claude_code` | CLI | ✅ supported — validated 2.1.278 | [guide](docs/user/install/claude-code.md) |
