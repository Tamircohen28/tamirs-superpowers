...
<p align="center">
  <a href="docs/engineering/build-and-release/platform-targets.json">
    <img src="https://img.shields.io/badge/Claude%20Code-2.1.234-blueviolet" alt="Claude Code" />
  </a>
  <a href="docs/engineering/build-and-release/platform-targets.json">
...
- At least one supported target — **Claude Code** 2.0+, **Cursor** 3.16.17+, **OpenAI Codex CLI** 0.40+, or **OpenCode** 1.16.2+ (see [per-target install](docs/user/install/README.md))
