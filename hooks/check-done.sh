...
if [ "${changed:-0}" -gt 0 ]; then
  printf '⚠ DoD reminder: %s changed code file(s) in '"'"'%s'"'"'. Before claiming done, confirm lint/typecheck/tests pass and cite the result — do not assert success without evidence.\n' \
